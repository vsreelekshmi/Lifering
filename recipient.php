...
if(isset($_POST['submitBtn'])){
    ...
    $ins1=mysql_query("insert into project.patientr(patient_id,bp,wg,hgb,duedate,haematocrit) values('$insid','$bp','$weight','$hemoglobin','$duedate','$hematocrit')") or die(mysql_error());
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-4">Diseases</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="bp" value="" placeholder="mmHg" class="form-control" required="true"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Weight</label>
                            <div class="col-sm-8">
                                <input type="decimal" name="weight" value="" placeholder="Kg" required="true" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4">Hemoglobin</label>
                            <div class="col-sm-8">
                                <input type="text" name="hemoglobin" value="" placeholder="Normal: 11.6-15.6 g/dl" required="true" class="form-control"/>
                            </div>
                       </div>
                        <div class="form-group">
                            <label class="col-sm-4">Hematocrit </label>
                            <div class="col-sm-8">
                                <input type="text" name="hematocrit" placeholder="Normal:34-36 %"value="" required="true" class="form-control"/>
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-4">Due Date</label>
                            <div class="col-sm-8">
                                <input type="date" name="duedate" class="form-control" required="true">
                            </div>
                        </div>
                         </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <button class="btn btn-success" name="submitBtn" >Add Recipient</button>
                            </div>
                        </div>
